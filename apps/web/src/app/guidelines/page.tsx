    ...
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-8">
      ...
      <header className="space-y-1">
        <h1 className="text-2xl font-bold">
          ...
          <span className="font-normal text-gray-600 dark:text-gray-400">Guidelines</span>
        </h1>
      ...
      {Object.entries(byDocument).map(([docName, articles]) => (
        <section key={docName} className="space-y-3">
          <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-800 pb-2">
            {docName}
          </h2>
          ...
          <div className="space-y-2">
            {articles
              ...
              .map((g) => (
                <div
                  key={g.article_id}
                  className="border border-gray-200 dark:border-gray-800 rounded p-4 space-y-2 hover:border-gray-300 dark:hover:border-gray-700 transition-colors"
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-baseline gap-2">
                      ...
                      {g.section && (
                        <span className="text-xs text-gray-400 dark:text-gray-600">{g.section}</span>
                      )}
                    </div>
