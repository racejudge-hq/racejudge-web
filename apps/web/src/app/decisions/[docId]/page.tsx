...
export default async function DecisionDetailPage({ params }: Props) {
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      <Link href="/decisions" className="text-sm text-gray-500 hover:text-white">
        ← All decisions
      </Link>
      ...
      <div className="flex gap-3 flex-wrap text-xs">
        <a
          ...
          className="px-3 py-1 border border-gray-700 rounded hover:border-gray-400"
        >
          View PDF ↗
        </a>
        <span className="px-3 py-1 border border-gray-800 rounded text-gray-600">
      ...
      <section>
        ...
        <pre className="whitespace-pre-wrap text-sm text-gray-300 leading-relaxed bg-gray-900 p-4 rounded overflow-auto max-h-[60vh]">
          {decision.raw_text || "(no text extracted)"}
        </pre>
      </section>

      <footer className="text-xs text-gray-700 pt-4 border-t border-gray-800">
