...
| `weather_context` | **820 (51.1%)** | Was 297, keyed off publication time. Now anchored on the earliest linked race control message, failing that the time the document states — never publication time — and bounded to 10 minutes. **813 of the 820 are within 95s of that anchor**, worst 496s. It rose from v16's 673 because v17's race control fix gave 173 more incidents a real anchor. |
